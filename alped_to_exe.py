...
def resource_path(relative_path):
    ...
    print(f"Sprawdzam ścieżkę: {full_path}")
    return full_path
...
def rysuj_logo(okno):
    orzelek_image = ctk.CTkImage(Image.open(resource_path("./images/logo.png")), size=(110, 110))
    orzelek_label = ctk.CTkLabel(okno, image=orzelek_image, text="")
    orzelek_label.place(x=30, y=40)

    logo_image = ctk.CTkImage(Image.open(resource_path("./images/wbis.png")), size=(300, 130))
